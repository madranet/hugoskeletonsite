...
* Here is the homepage. It has ```type = "homepage"``` defined in the front-matter.
* The template being used to display this post on its own like this is in ```/themes/skeletontheme/layouts/index.html```
